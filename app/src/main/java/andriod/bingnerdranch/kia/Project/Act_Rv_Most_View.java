...
public class Act_Rv_Most_View extends AppCompatActivity {

    APIInterface request;
    @BindView(R.id.rv_all_most_view)
    RecyclerView rv_all_most_view;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_rv_most_veiw);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ButterKnife.bind(this);
        rv_all_most_view.setHasFixedSize(true);
        rv_all_most_view.setLayoutManager(new LinearLayoutManager(context, rv_all_most_view.VERTICAL,false));
        request = APIClient.getApiClient("http://192.168.43.167/kia/").create(APIInterface.class);
     //   getData_most_view();
    }


//    private void getData_most_view() {
//
//        request.getData_most_view().enqueue(new Callback<List<Rv_Home_Mdl>>() {
//            @Override
...
//                rv_all_most_view.setAdapter(rv_all_home_adp);
//            }
//
//            @Override
//            public void onFailure(Call<List<Rv_Home_Mdl>> call, Throwable t) {
//
//                Toast.makeText(Act_Rv_Most_View.this, t.getMessage(), Toast.LENGTH_SHORT).show();
