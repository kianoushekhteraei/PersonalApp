...
public class Act_Detail_Home extends AppCompatActivity {
    ...
    TextView tv_name_prd_detail_home, tv_aprice_detail_home, tv_bprice_detail_home, tv_description_detail_home, tv_off_detail_home;
    ImageView iv_prd_detail_home  , iv_whish_detail_home;
    ConstraintLayout cl_buy_detail_home;
    ...
    @OnClick(R.id.cl_buy_detail_home)
    public void cl_buy_detail_home(){

        Intent i = new Intent(Act_Detail_Home.this,Act_Buy_Product.class);
        startActivity(i);
        PostData_orders();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_description_detail_home = findViewById(R.id.tv_description_detail_home);
        tv_off_detail_home = findViewById(R.id.tv_off_detail_home);
        iv_prd_detail_home = findViewById(R.id.iv_prd_detail_home);
        ...
        tv_name_prd_detail_home.setText(name_orders);

        description = bundle.getString("description");
        tv_description_detail_home.setText(description);
        ...
        iv_whish_detail_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (flag) {
                    iv_whish_detail_home.setImageResource(R.drawable.ic_whish_black);
                    flag = false;
                } else {
                    iv_whish_detail_home.setImageResource(R.drawable.ic_whish_green);
                    flag = true;
                    PostData_favourite();
                }
        ...
        call.enqueue(new Callback<Post_Data_Whish_List_Mdl>() {
            ...
            public void onResponse(Call<Post_Data_Whish_List_Mdl> call, Response<Post_Data_Whish_List_Mdl> response) {
                ...
                if (response.body().getResponse().equals("DATA_REGISTERED")) {
                    ...
                    Toast.makeText(Act_Detail_Home.this, "مورد انتخابی قبلا افزوده شده است.", Toast.LENGTH_SHORT).show();
